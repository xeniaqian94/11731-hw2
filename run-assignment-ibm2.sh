...
python phrase_extract.py --train_source $TRAIN_DATA.de --train_target $TRAIN_DATA.en --align_output $OUT_DIR/alignment.txt --phrase_output $OUT_DIR/phrase.txt $NULL_ALIGNMENT
